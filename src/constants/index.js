...
export const services = [
    ...
    {
        imgURL: support,
        label: "Temos satisfação em ajudar você",
...
export const reviews = [
    {
        ...
        rating: 4.5,
        feedback: "A atenção aos detalhes e a qualidade do produto superaram minhas expectativas. Altamente recomendado!"
    },
    {
        imgURL: customer2,
        customerName: 'Lota Mongeskar',
        rating: 4.5,
        feedback: "O produto não apenas atendeu, mas superou minhas expectativas. Com certeza serei um cliente recorrente!"
    }
];
